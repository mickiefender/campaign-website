            ...
            <div className="animate-fade-in-right">
              ...
              <div className="space-y-4 mb-8">
                <p className="text-base md:text-lg text-gray-600 leading-relaxed">
                  Dr. Charles Dwamena is a visionary leader with decades of experience in public service, a luminary in Finance and Administration. Born and raised in Ghana, he understands the unique challenges facing our nation and is committed to delivering real solutions.
                </p>
              </div>
